...
(
    ...
    multipleScore       double(2, 1) default 0.0               null comment '综合评分',
...
(
    Id                   char(50)    default '' not null comment '主键'
        primary key,
    dataId               char(50)    default '' not null comment '数据源',
    position             varchar(50) default '' null comment '期待职位',
    city                 varchar(50) default '' null comment '期待城市',
    starting_salary_from varchar(50) default '' null comment '期待起薪from',
    starting_salary_to   varchar(50) default '' null comment '期待起薪to'
)
    comment '求职意向表';
...
(
    ...
    professional_title varchar(50) default '' null comment '专业名称',
    education          varchar(50) default '' null comment '学历',
    graduation_time    timestamp              null comment '毕业时间'
)
    comment '教育经历表';
...
(
    ...
    numberOfWorkers varchar(20)  default '0' null comment '员工人数'
)
    comment '企业信息表';
...
(
    pId         char(50)    default ''                not null comment '主键'
        primary key,
    dataId      char(50)    default ''                not null comment '公司ID',
...
(
    ...
    Resume_path          varchar(200) default ''                null comment '简历路径',
    companyName          varchar(50)  default ''                null comment '公司名称',
    company_industry     varchar(50)  default ''                null comment '公司行业',
    department           varchar(50)  default ''                null comment '所属部门',
    tybe_of_job          varchar(50)  default ''                null comment '职位类型',
    position_Name        varchar(50)  default ''                null comment '职位名称',
    operating_hours      varchar(50)  default ''                null comment '工作时间',
    schoolName           varchar(50)  default ''                null comment '学校名称',
    professional_title   varchar(50)  default ''                null comment '专业名称',
    education            varchar(50)  default ''                null comment '学历',
    graduation_time      timestamp                              null comment '毕业时间',
